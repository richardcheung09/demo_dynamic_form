...
function validateValue<T>(
  ...
  switch (validationType) {
    case ValidationType.Email:
      if (
        typeof value === "string" &&
        (value.length > 100 || !/\S+@\S+\.\S+/.test(value))
      ) {
    ...
    case ValidationType.PhoneNumber:
      if (
        ...
        value &&
        (!value.match(/\d/g) ||
          ![10, 11].includes((value.match(/\d/g) ?? []).length))
      ) {
        toast.error(
...
export function EditForm(props: EditFormProps) {
  ...
  type UploadPhotoMap = {
    [key: string]: string; // Each key is a string, and the value is a string (file path)
  };
  ...
  const [radioFieldValue, setRadioFieldValue] = useState<number>(0);
  useEffect(() => {
    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative lg:pt-5 text-left">
      ...
      <form
        ...
        onSubmit={(event: React.FormEvent<HTMLFormElement>) => {
          ...
          for (const target1 of event.currentTarget.elements) {
          ...
          for (const editEntry of props.editEntries) {
            ...
            if (editEntry.type === EditEntryType.Showcase) {
              ...
              //   (image_url: { state: any; }) => image_url.state !== StoredFileState.Deleted
              // ).length;
                    ...
                    >
                      ...
                      <div className="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                        <div className="col-span-6">
                          <label
                            htmlFor={editEntry.attribute + "_street_address"}
                            className="block text-sm font-medium text-gray-700"
                          >
                            Street Address
                          </label>
                        ...
                        <div className="col-span-6 sm:col-span-3">
                          <label
                            htmlFor={editEntry.attribute + "_city"}
                            className="block text-sm font-medium text-gray-700"
                          >
                            City/Town
                          </label>
                        ...
                        <div className="col-span-6 sm:col-span-3">
                          <label
                            htmlFor={editEntry.attribute + "_province"}
                            className="block text-sm font-medium text-gray-700"
                          >
                            State
                          </label>
                        ...
                        <div className="col-span-6 sm:col-span-3">
                          <label
                            htmlFor={editEntry.attribute + "_country"}
                            className="block text-sm font-medium text-gray-700"
                          >
                            Country*
                          </label>
                          <div className="my-2">
                            <select
                              ...
                              defaultValue={
                                entity && entity[editEntry.attribute]["country"]
                              }
                        ...
                        <div className="col-span-6 sm:col-span-3">
                          <label
                            htmlFor={editEntry.attribute + "_postal_code"}
                            className="block text-sm font-medium text-gray-700"
                          >
                            Postal Code
                          </label>
